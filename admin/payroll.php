		...
		<main class="main">
			<div class="data-table">
				<div style="padding: 20px 24px 16px 24px; border-bottom: 1px solid rgba(0, 0, 0, 0.05);">
					<h3 style="margin: 0; font-size: 18px; font-weight: 600; color: #2d3748; display: flex; align-items: center; gap: 8px;">
						<i class="fas fa-calculator" style="width: 20px; height: 20px; color: #667eea;"></i>
						Calculate Payroll
					</h3>
					<p style="margin: 8px 0 0 0; color: #718096; font-size: 14px;">Select a staff member to calculate their payroll</p>
				</div>
					...
					<table style="width: 100%; border-collapse: collapse; min-width: 1000px;">
						<thead>
							<tr>
								...
								<th style="padding: 16px 20px; text-align: center; border-bottom: 1px solid rgba(0, 0, 0, 0.05); background: rgba(102, 126, 234, 0.1); font-weight: 600; color: #2d3748; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px;"><i class="fas fa-calculator"></i> Calculate Payroll</th>
							</tr>
						</thead>
						<tbody>
							<?php
							...
							while ($row = mysqli_fetch_array($qry))
							{
								...
								echo "<a href='pay.php?id=" . $row['staff_id'] . "' style='background: #667eea; color: white; padding: 8px 16px; border-radius: 8px; text-decoration: none; font-size: 13px; font-weight: 600; transition: all 0.3s ease; display: inline-flex; align-items: center; gap: 6px;' onmouseover=\"this.style.background='#5a67d8'; this.style.transform='translateY(-2px)'\" onmouseout=\"this.style.background='#667eea'; this.style.transform='translateY(0)'\">";
								echo "<i class='fas fa-calculator'></i>";
								echo "Calculate Payroll";
								echo "</a>";
								echo "</td>";
								echo "</tr>";
							}
			...
			<div class="card" style="margin-top: 24px;">
				...
				<div style="display: flex; gap: 16px; flex-wrap: wrap;">
					...
					<a href="print.php" class="btn" style="display: flex; align-items: center; gap: 8px;">
