			...
			<div class="card">
				...
				<div class="message-details">
					<div class="message-field">
						<label><i class="fas fa-id-card"></i> Receiver ID</label>
						<div class="field-value"><?php echo $row['staff_id']; ?></div>
					</div>
					
					<div class="message-field">
						<label><i class="fas fa-user-friends"></i> Receiver Name</label>
						<div class="field-value"><?php echo $row['receiver']; ?></div>
					</div>
					
					<div class="message-field">
						<label><i class="fas fa-tag"></i> Subject</label>
						<div class="field-value"><?php echo $row['msg_subject']; ?></div>
					</div>
					
					<div class="message-field message-content">
						<label><i class="fas fa-comment"></i> Message</label>
						<div class="field-value message-text"><?php echo nl2br(stripslashes($row['msg_msg'])); ?></div>
					</div>
				</div>
				...
				<div class="message-actions">
					...
					<a href="delete.php?so_id=<?php echo $so_id; ?>" class="btn" style="background: #e53e3e; display: flex; align-items: center; gap: 8px;" onclick="return confirm('Are you sure you want to delete this message?')">
