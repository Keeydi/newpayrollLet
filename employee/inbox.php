		...
		<main class="main">
			<div class="data-table">
				<div style="padding: 20px 24px 16px 24px; border-bottom: 1px solid rgba(0, 0, 0, 0.05);">
					<h3 style="margin: 0; font-size: 18px; font-weight: 600; color: #2d3748; display: flex; align-items: center; gap: 8px;">
						<i class="fas fa-inbox" style="width: 20px; height: 20px; color: #667eea;"></i>
						Inbox Messages
					</h3>
					<p style="margin: 8px 0 0 0; color: #718096; font-size: 14px;">View and manage your received messages</p>
				</div>
				...
				<div style="overflow-x: auto;">
					<table style="width: 100%; border-collapse: collapse; min-width: 800px;">
						<thead>
							<tr>
								<th style="padding: 16px 20px; text-align: left; border-bottom: 1px solid rgba(0, 0, 0, 0.05); background: rgba(102, 126, 234, 0.1); font-weight: 600; color: #2d3748; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px;"><i class="fas fa-calendar"></i> Received Date</th>
						...
						<tbody>
							...
							<tr style="transition: all 0.3s ease;" onmouseover="this.style.background='rgba(102, 126, 234, 0.05)'" onmouseout="this.style.background='transparent'">
								<td style="padding: 16px 20px; text-align: left; border-bottom: 1px solid rgba(0, 0, 0, 0.05); color: #4a5568; font-weight: 500;"><?php echo $tbl['received_date']; ?></td>
								<td style="padding: 16px 20px; text-align: left; border-bottom: 1px solid rgba(0, 0, 0, 0.05); color: #4a5568; font-weight: 500;"><?php echo $tbl['sender']; ?></td>
								...
								<td style="padding: 16px 20px; text-align: center; border-bottom: 1px solid rgba(0, 0, 0, 0.05); color: #4a5568; font-weight: 500;">
									<div style="display: flex; gap: 8px; justify-content: center; flex-wrap: wrap;">
										<a href="more.php?id=<?php echo $tbl['id']; ?>" style="background: #3182ce; color: white; padding: 6px 12px; border-radius: 6px; text-decoration: none; font-size: 12px; transition: all 0.3s ease;" onmouseover="this.style.background='#2c5282'" onmouseout="this.style.background='#3182ce'"><i class="fas fa-eye"></i> Read More</a>
										<a href="inboxdelete.php?id=<?php echo $tbl['id']; ?>" style="background: #e53e3e; color: white; padding: 6px 12px; border-radius: 6px; text-decoration: none; font-size: 12px; transition: all 0.3s ease;" onmouseover="this.style.background='#c53030'" onmouseout="this.style.background='#e53e3e'" onclick="return confirm('Are you sure you want to delete this message?')"><i class="fas fa-trash"></i> Delete</a>
									</div>
								</td>
							</tr>
							<?php } ?>
			...
			<div class="card" style="margin-top: 24px;">
				...
				<div style="display: flex; gap: 16px; flex-wrap: wrap;">
					...
					<a href="outbox.php" class="btn" style="display: flex; align-items: center; gap: 8px;">
